...
!function (t, e, i, n) {
  ...
  function o(t, e, i) {
    var s;
    if (t) if (t.forEach) t.forEach(e, i);else if (t.length !== n) for (s = 0; s < t.length;) {
      e.call(i, t[s], s, t), s++;
    } else for (s in t) {
  ...
  function h(t, e) {
    return _typeof(t) == ft ? t.apply(e ? e[0] || n : n, e) : t;
  }
  ...
  function H(t, e) {
    ...
    if (r = i.filter(function (t) {
      return f(t.target, l);
    }), e === Pt) for (s = 0; s < r.length;) {
      n[r[s].identifier] = !0, s++;
    }

    for (s = 0; s < o.length;) {
      n[o[s].identifier] && a.push(o[s]), e & (Rt | Mt) && delete n[o[s].identifier], s++;
    }
    ...
    recognize: function recognize(t) {
      ...
      if (!e.stopped) {
        ...
        for (var r = 0; r < n.length;) {
          i = n[r], e.stopped === xe || s && i != s && !i.canRecognizeWith(s) ? i.reset() : i.recognize(t), !s && i.state & (ve | me | ge) && (s = e.curRecognizer = i), r++;
        }
      }
    },
    get: function get(t) {

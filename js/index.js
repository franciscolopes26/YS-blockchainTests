                            ...
                            c = ze.prototype, c.x = c.y = c.z = c.skewX = c.skewY = c.rotation = c.rotationX = c.rotationY = c.zOrigin = c.xPercent = c.yPercent = c.xOffset = c.yOffset = 0, c.scaleX = c.scaleY = c.scaleZ = 1, Se("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                                parser: function(e, t, n, i, r, a, l) {
                                    ...
                                    if (i._transform = C, R && "string" == typeof R && Ce) d = U.style, d[Ce] = R, d.display = "block", d.position = "absolute", X.body.appendChild(U), h = Ve(U, null, !1), C.svg && (v = C.xOrigin, x = C.yOrigin, h.x -= C.xOffset, h.y -= C.yOffset, (M.transformOrigin || M.svgOrigin) && (R = {}, Ne(e, le(M.transformOrigin), R, M.svgOrigin, M.smoothOrigin, !0), v = R.xOrigin, x = R.yOrigin, h.x -= R.xOffset - C.xOffset, h.y -= R.yOffset - C.yOffset),
                                        (v || x) && (y = Ue(U, !0), h.x -= v - (v * y[0] + x * y[2]), h.y -= x - (v * y[1] + x * y[3]))), X.body.removeChild(U), h.perspective || (h.perspective = C.perspective), null != M.xPercent && (h.xPercent = ce(M.xPercent, C.xPercent)), null != M.yPercent && (h.yPercent = ce(M.yPercent, C.yPercent));
        ...
        function i() {
            if (o.useDisclaimer)
                if (r.isFirefox || r.isChrome) {
                    var e = ["\n%c Created by DYNAMIC %c http://dynamic-studio.net/ \n\n", "color: #fff; background: #222; padding:5px 5px;", "color: #999; background: #FCFCFC; padding:5px 0;"];
                    window.console.log.apply(console, e)
                } else window.console.log("Created by DYNAMIC - http://dynamic-studio.net/")
        }
        var r = e(59),
            o = e(62);
        n.add = i
